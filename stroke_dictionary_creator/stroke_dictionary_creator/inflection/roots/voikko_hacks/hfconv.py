# TODO this is a direct copy of this file. It should come in a more managed fashion.
# https://raw.githubusercontent.com/sp3ctum/corevoikko/feature/exploration/voikko-fi/common/hfconv.py
...
modern_classmap = [('valo', 'sw', [(None,'(.*)','valo'),
                   ...
                   # I have modified some of these, it seemed like there were errors.
                   #
                   ('voida', 'ws', [('d','(.*)idA','voida')]),
                   ('käydä', None, [(None,'(.*)UdA','käydä')]),
                   ('kanavoida', 'ws', [('d','(.*O)idA','kanavoida')]),
                   ...
                   ('katsella', 'ws', [(None,'(.*Ael)lA','arvailla'),
                                       ...
                                       ('d','(.*)dellA','kohdella'),
                                       ('>k','(.*)ellA','nakella')]),
                   ('haravoida', 'ws', [('d','(.*O)idA','haravoida')]),
