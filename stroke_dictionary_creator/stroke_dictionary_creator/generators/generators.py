...
end_diphtong_ui = morpheme("ui", "eoi")
end_diphtong_yi = morpheme("yi", "eoi")
end_diphtong_ua = morpheme("ua", "eoa")
end_diphtong_yä = morpheme("yä", "eoa")
...
middle_vocal_sound = long_vowel | middle_diphtong | middle_vowel
